                ...
                <div class="row">
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox disabled runat="server" ID="ApellidoYNombreText" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:DropDownList disabled runat="server" ID="GeneroSelect" class="form-select">
                    ...
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:DropDownList disabled runat="server" ID="PaisSelect" class="form-select">
                                    <asp:ListItem Value="0" Text="Todos" Selected="True" />
                ...
                <div class="row">
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox disabled runat="server" ID="LocalidadText" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:DropDownList disabled runat="server" ID="ContactoInternoSelect" class="form-select">
                                    <asp:ListItem Value="0" Text="Todos" Selected="True" />
                    ...
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox disabled runat="server" ID="OrganizacionText" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:DropDownList disabled runat="server" ID="AreaSelect" class="form-select">
                                    <asp:ListItem Value="0" Text="Todos" Selected="True" />
                    ...
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <asp:DropDownList disabled runat="server" ID="ActivoSelect" class="form-select">
                                    <asp:ListItem Value="0" Text="Todos" Selected="True" />
                                    <asp:ListItem Value="1" Text="Si" />
                                    <asp:ListItem Value="2" Text="No" />
                    ...
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox disabled runat="server" ID="DireccionText" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox disabled runat="server" ID="TelefonoFijoInternoText" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox disabled runat="server" ID="TelefonoCelularText" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox disabled runat="server" ID="EmailText" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox disabled runat="server" ID="CuentaSkypeText" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
